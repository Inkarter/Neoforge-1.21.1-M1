...
{
    //shift twice search AxeItem V Include non-project items
    //shift twice search AxeItem V Include non-project items
    //shift twice search AxeItem V Include non-project items
    public PaxelItem(Tier tier, Properties properties)
    {
        super(tier, ModTags.Blocks.PAXEL_MINABLE, properties);
    }
    protected static final Map<Block, Block> STRIPPABLES = new ImmutableMap.Builder<Block, Block>()
            ...
            .put(Blocks.BAMBOO_BLOCK, Blocks.STRIPPED_BAMBOO_BLOCK)//add here custom blocks if I want them be stripped
            .build();
